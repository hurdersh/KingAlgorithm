...
eve(initialize):-a(message(agent1,send_message(initialize(1,1,1),var_Me))),a(message(agent2,send_message(initialize(2,2,2),var_Me))),a(message(agent3,send_message(initialize(3,3,3),var_Me))),a(message(var_ALL,send_message(show_preferred,var_Me))),write('Each Agent is initialized').
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_330509,var_Ontology,_330513),_330503),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_330547)),a(message(var_Ag,propose(var_A,[_330547],var_AgI))),retractall(ext_agent(var_Ag,_330585,var_Ontology,_330589)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_330383,var_Ontology,_330387),_330377),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_330453,var_Ontology,_330457)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_330271,var_Ontology,_330275),_330265),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_330327,var_Ontology,_330331)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_329835),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_329869),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_329651).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_329499),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_329447),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_329323,_329325)),clause(agente(_329345,_329347,_329349,var_S),_329341),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_329117,_329119,_329121,var_S),_329113),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_329217,[]),repeat,read(_329217,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_329217).

...
eve(initialize):-a(message(agent1,send_message(initialize(1,3,1),var_Me))),a(message(agent2,send_message(initialize(2,3,2),var_Me))),a(message(agent3,send_message(initialize(3,3,3),var_Me))),a(message(var_ALL,send_message(show_preferred,var_Me))),write('Each Agent is initialized').

eve(firstbroadcast):-a(message(var_ALL,send_message(start_consensus,var_Me))).

eve(firstupdatemajority):-a(message(var_ALL,send_message(update_majority,var_Me))).

eve(kingbroadcast):-a(message(var_ALL,send_message(king_broadcast,var_Me))).

eve(nextround):-a(message(var_ALL,send_message(show_preferred,var_Me))),a(message(var_ALL,send_message(nextround,var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_331409,var_Ontology,_331413),_331403),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_331447)),a(message(var_Ag,propose(var_A,[_331447],var_AgI))),retractall(ext_agent(var_Ag,_331485,var_Ontology,_331489)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_331283,var_Ontology,_331287),_331277),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_331353,var_Ontology,_331357)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_331171,var_Ontology,_331175),_331165),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_331227,var_Ontology,_331231)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_330735),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_330769),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_330551).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_330399),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_330347),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_330223,_330225)),clause(agente(_330245,_330247,_330249,var_S),_330241),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_330017,_330019,_330021,var_S),_330013),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_330117,[]),repeat,read(_330117,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_330117).
